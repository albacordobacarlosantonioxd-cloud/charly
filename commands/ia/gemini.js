...
export default {
    ...
    run: async (sock, m, from, text, quoted) => {
        ...
        if (!text) return sock.sendMessage(from, { text: '¿Qué onda wero? Pregúntame algo con el poder de Gemini 2.5.' }, { quoted: m });
        ...
        try {
            ...
            if (e.response) {
                ...
                const errorMsg = e.response.data.error?.message || "Error desconocido";
                await sock.sendMessage(from, { text: `❌ Error en Gemini 2.5: ${errorMsg}` }, { quoted: m });
            } else {
