module.exports = {
    ...
    run: async (sock, m, from, text, quoted, args, isAdmin, isGroup) => {
        ...
        try {
            ...
            await sock.sendMessage(from, { text: `✅ @${user.split("@")[0]} ha sido degradado de administrador.`, mentions: [user] }, { quoted: m });
        } catch (e) {
            console.error("Error al degradar participante:", e);
            await sock.sendMessage(from, { text: "❌ Hubo un error al intentar degradar. Asegúrate de que el bot sea administrador." }, { quoted: m });
        }
    }
};
